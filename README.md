...
<ul dir="rtl">
  ...
  <li><a href="https://github.com/pfont/pfont">thewhite - قالب ساده ووردپرس</a></li>
</ul>
...
<p dir="rtl"> اگر پروژه‌ای منتشر نموده‌اید یا می شناسید که سازنده آن ایرانی می باشد (هر چند کوچک یا قدیمی برای هر مقصودی اعم از فارسی، انگلیسی، آموزشی، گرافیکی و ...) که فکر می کنید ممکن است جالب یا مفید باشد (به شرط در دسترس بودن کد در صورتی که برنامه باشد یا آزاد بودن استفاده در صورتی که محتوایی غیر از برنامه اجرایی باشد) در اینجا قرار دهید تا احیانا افراد بیشتری بتوانند با آن آشنا گردند و از آن استفاده نمایند.</p>
